 ...
 */
	protected function _url() {
		...
		if (empty($uri) || $uri === '/' || $uri === '//' || $uri === '/Index.phpController.php') {
			$uri = '/';
		}
		$endsWithIndex = '/webroot/Index.phpController.php';
 ...
 *
 * If CakePHP is called with Index.phpController.php in the URL even though
 ...
 */
	protected function _base() {
		...
		if (!$baseUrl) {
			...
			$indexPos = strpos($base, '/webroot/Index.phpController.php');
			if ($indexPos !== false) {
