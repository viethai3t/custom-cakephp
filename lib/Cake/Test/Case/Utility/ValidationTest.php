 ...
 */
	public function testUrl() {
		...
		$this->assertTrue(Validation::url('http://www.domain.com/blogs/Index.phpController.php?blog=6&tempskin=_rss2'));
		$this->assertTrue(Validation::url('http://www.domain.com/blogs/parenth()eses.php'));
		$this->assertTrue(Validation::url('http://www.domain.com/Index.phpController.php?get=params&amp;get2=params'));
