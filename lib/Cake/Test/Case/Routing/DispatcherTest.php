 ...
 */
	public function testDispatchBasic() {
		...
		Configure::write('App.baseUrl', '/pages/Index.phpController.php');
		...
		$Dispatcher = new TestDispatcher();
		Configure::write('App.baseUrl', '/timesheets/Index.phpController.php');
		...
		$this->assertEquals('/timesheets/Index.phpController.php', $url->base);
 ...
 */
	public function testAdminDispatch() {
		...
		Configure::write('App.baseUrl', '/cake/repo/branches/1.2.x.x/Index.phpController.php');
		...
		$expected = '/cake/repo/branches/1.2.x.x/Index.phpController.php/admin/test_dispatch_pages/index/param:value/param2:value2';
		$this->assertSame($expected, $Dispatcher->controller->here);

		$expected = '/cake/repo/branches/1.2.x.x/Index.phpController.php';
 ...
 */
	public function testAutomaticPluginDispatch() {
		$_POST = array();
		$_SERVER['PHP_SELF'] = '/cake/repo/branches/1.2.x.x/Index.phpController.php';
