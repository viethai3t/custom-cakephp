 ...
 */
	public function testBaseUrlAndWebrootWithModRewrite() {
		...
		$_SERVER['PHP_SELF'] = '/urlencode me/app/webroot/Index.phpController.php';
		...
		$_SERVER['DOCUMENT_ROOT'] = '/cake/repo/branches';
		$_SERVER['PHP_SELF'] = '/1.2.x.x/app/webroot/Index.phpController.php';
		$_SERVER['PATH_INFO'] = '/posts/view/1';
		...
		$_SERVER['PHP_SELF'] = '/Index.phpController.php';
		...
		$_SERVER['PHP_SELF'] = '/webroot/Index.phpController.php';
		$request = new CakeRequest();
		...
		$_SERVER['PHP_SELF'] = '/app/webroot/Index.phpController.php';
		$request = new CakeRequest();
		...
		$_SERVER['DOCUMENT_ROOT'] = '/cake/repo/branches';
		$_SERVER['PHP_SELF'] = '/demos/auth/webroot/Index.phpController.php';
		...
		$_SERVER['PHP_SELF'] = '/clients/PewterReport/code/webroot/Index.phpController.php';
		$request = new CakeRequest();
 ...
 */
	public function testBaseUrlwithModRewriteAlias() {
		...
		$_SERVER['PHP_SELF'] = '/control/Index.phpController.php';
		...
		$_SERVER['PHP_SELF'] = '/newaffiliate/Index.phpController.php';
		$request = new CakeRequest();
 ...
 * CakePHP gets called with Index.phpController.php in URL nonetheless.
 *
 * Tests uri with
 * - Index.phpController.php/
 * - Index.phpController.php/
 * - Index.phpController.php/apples/
 * - Index.phpController.php/bananas/eat/tasty_banana
 *
 * @return void
 */
	public function testBaseUrlWithModRewriteAndIndexPhp() {
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/Index.phpController.php';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/Index.phpController.php';
		...
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/Index.phpController.php/apples';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/Index.phpController.php/apples';
		...
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/Index.phpController.php/melons/share/';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/Index.phpController.php/melons/share/';
		...
		$_SERVER['REQUEST_URI'] = '/cakephp/app/webroot/Index.phpController.php/bananas/eat/tasty_banana';
		$_SERVER['PHP_SELF'] = '/cakephp/app/webroot/Index.phpController.php/bananas/eat/tasty_banana';
...
/**
 * Test that even if mod_rewrite is on, and the url contains Index.phpController.php
 ...
 */
	public function testBaseUrlWithModRewriteAndExtraSlashes() {
		$_SERVER['REQUEST_URI'] = '/cakephp/webroot///Index.phpController.php/bananas/eat';
		$_SERVER['PHP_SELF'] = '/cakephp/webroot///Index.phpController.php/bananas/eat';
 ...
 */
	public function testBaseUrlWithNoModRewrite() {
		...
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/cake/Index.phpController.php';
		$_SERVER['PHP_SELF'] = '/cake/Index.phpController.php/posts/index';
		$_SERVER['REQUEST_URI'] = '/cake/Index.phpController.php/posts/index';

		Configure::write('App', array(
			'dir' => APP_DIR,
			'webroot' => WEBROOT_DIR,
			'base' => false,
			'baseUrl' => '/cake/Index.phpController.php'
		));

		$request = new CakeRequest();
		$this->assertEquals('/cake/Index.phpController.php', $request->base);
 ...
 */
	public function testBaseUrlAndWebrootWithBaseUrl() {
		...
		Configure::write('App.baseUrl', '/app/webroot/Index.phpController.php');

		$request = new CakeRequest();
		$this->assertEquals('/app/webroot/Index.phpController.php', $request->base);
		...
		Configure::write('App.baseUrl', '/app/Index.phpController.php');
		$request = new CakeRequest();
		$this->assertEquals('/app/Index.phpController.php', $request->base);
		$this->assertEquals('/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/CakeBB/app/webroot/Index.phpController.php');
		$request = new CakeRequest();
		$this->assertEquals('/CakeBB/app/webroot/Index.phpController.php', $request->base);
		$this->assertEquals('/CakeBB/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/CakeBB/app/Index.phpController.php');
		$request = new CakeRequest();

		$this->assertEquals('/CakeBB/app/Index.phpController.php', $request->base);
		$this->assertEquals('/CakeBB/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/CakeBB/Index.phpController.php');
		$request = new CakeRequest();

		$this->assertEquals('/CakeBB/Index.phpController.php', $request->base);
		$this->assertEquals('/CakeBB/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/dbhauser/Index.phpController.php');
		$_SERVER['DOCUMENT_ROOT'] = '/kunden/homepages/4/d181710652/htdocs/joomla';
		$_SERVER['SCRIPT_FILENAME'] = '/kunden/homepages/4/d181710652/htdocs/joomla/dbhauser/Index.phpController.php';
		$request = new CakeRequest();

		$this->assertEquals('/dbhauser/Index.phpController.php', $request->base);
		$this->assertEquals('/dbhauser/app/webroot/', $request->webroot);
	}

/**
 * Test baseUrl with no rewrite and using the top level Index.phpController.php.
 *
 * @return void
 */
	public function testBaseUrlNoRewriteTopLevelIndex() {
		Configure::write('App.baseUrl', '/Index.phpController.php');
		$_SERVER['DOCUMENT_ROOT'] = '/Users/markstory/Sites/cake_dev';
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/cake_dev/Index.phpController.php';

		$request = new CakeRequest();
		$this->assertEquals('/Index.phpController.php', $request->base);
		$this->assertEquals('/app/webroot/', $request->webroot);
	}
 ...
 */
	public function testBaseUrlWithAppAndWebrootInDirname() {
		Configure::write('App.baseUrl', '/approval/Index.phpController.php');
		$_SERVER['DOCUMENT_ROOT'] = '/Users/markstory/Sites/';
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/approval/Index.phpController.php';

		$request = new CakeRequest();
		$this->assertEquals('/approval/Index.phpController.php', $request->base);
		$this->assertEquals('/approval/app/webroot/', $request->webroot);

		Configure::write('App.baseUrl', '/webrootable/Index.phpController.php');
		$_SERVER['DOCUMENT_ROOT'] = '/Users/markstory/Sites/';
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/webrootable/Index.phpController.php';

		$request = new CakeRequest();
		$this->assertEquals('/webrootable/Index.phpController.php', $request->base);
		$this->assertEquals('/webrootable/app/webroot/', $request->webroot);
	}

/**
 * Test baseUrl with no rewrite, and using the app/webroot/Index.phpController.php file as is normal with virtual hosts.
 *
 * @return void
 */
	public function testBaseUrlNoRewriteWebrootIndex() {
		...
		$_SERVER['SCRIPT_FILENAME'] = '/Users/markstory/Sites/cake_dev/app/webroot/Index.phpController.php';
 ...
 */
	public function testGetParamsWithDot() {
		...
		$_SERVER['PHP_SELF'] = '/cake_dev/app/webroot/Index.phpController.php';
		...
		return array(
			array(
				...
				array(
					'App' => array(
						'base' => false,
						'baseUrl' => '/Index.phpController.php',
						'dir' => 'app',
						'webroot' => 'webroot'
					),
					'SERVER' => array(
						'SCRIPT_NAME' => '/Index.phpController.php',
						'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot',
						'QUERY_STRING' => '',
						'REQUEST_URI' => '/Index.phpController.php',
						'URL' => '/Index.phpController.php',
						'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\Index.phpController.php',
						'ORIG_PATH_INFO' => '/Index.phpController.php',
						'PATH_INFO' => '',
						'ORIG_PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot\\Index.phpController.php',
						'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot',
						'PHP_SELF' => '/Index.phpController.php',
					),
				),
				array(
					'base' => '/Index.phpController.php',
					'webroot' => '/app/webroot/',
					'url' => ''
				),
			),
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'REQUEST_URI' => '/Index.phpController.php?/posts/add',
						'PHP_SELF' => '',
						'URL' => '/Index.phpController.php?/posts/add',
						'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot',
			...
			array(
				...
				array(
					'App' => array(
						'base' => false,
						'baseUrl' => '/site/Index.phpController.php',
						'dir' => 'app',
						'webroot' => 'webroot',
					),
					'SERVER' => array(
						'SCRIPT_NAME' => '/site/Index.phpController.php',
						'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot',
						'QUERY_STRING' => '',
						'REQUEST_URI' => '/site/Index.phpController.php',
						'URL' => '/site/Index.phpController.php',
						'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\site\\Index.phpController.php',
						'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot',
						'PHP_SELF' => '/site/Index.phpController.php',
						'argv' => array(),
						'argc' => 0
					),
				),
				array(
					'url' => '',
					'base' => '/site/Index.phpController.php',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot',
						'QUERY_STRING' => '/posts/add',
						'REQUEST_URI' => '/site/Index.phpController.php/posts/add',
						'URL' => '/site/Index.phpController.php/posts/add',
						'ORIG_PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot\\site\\Index.phpController.php',
						'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot',
						'PHP_SELF' => '/site/Index.phpController.php/posts/add',
						'argv' => array('/posts/add'),
						'argc' => 1
					),
				),
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/app/webroot/Index.phpController.php',
						'QUERY_STRING' => '',
						'REQUEST_URI' => '/Index.phpController.php/posts/index',
						'SCRIPT_NAME' => '/Index.phpController.php',
						'PATH_INFO' => '/posts/index',
						'PHP_SELF' => '/Index.phpController.php/posts/index',
					),
				),
				array(
					'url' => 'posts/index',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/Index.phpController.php',
						'REQUEST_URI' => '/site/Index.phpController.php/posts/index',
						'SCRIPT_NAME' => '/site/Index.phpController.php',
						'PATH_INFO' => '/posts/index',
						'PHP_SELF' => '/site/Index.phpController.php/posts/index',
					),
				),
				array(
					'url' => 'posts/index',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'DOCUMENT_ROOT' => '/Library/WebServer/Documents',
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/Index.phpController.php',
						'REQUEST_URI' => '/site/Index.phpController.php/posts/index?a=b&c=d',
						'SCRIPT_NAME' => '/site/Index.phpController.php',
						'PATH_INFO' => '/posts/index',
						'PHP_SELF' => '/site/Index.phpController.php/posts/index',
			...
			array(
				...
				array(
					...
					'SERVER' => array(
						...
						'SCRIPT_FILENAME' => '/Library/WebServer/Documents/site/Index.phpController.php',
						'REQUEST_URI' => '/site/',
						'SCRIPT_NAME' => '/site/app/webroot/Index.phpController.php',
						'PHP_SELF' => '/site/app/webroot/Index.phpController.php',
					),
				),
				array(
					'url' => '',
