...
/**
 * Test URLs like http://cakephp.org/Index.phpController.php?somestring without key/value pair for query
 *
 * @return void
 */
	public function testRequestWithStringQuery() {
		...
		$request = array(
			'uri' => array(
				'scheme' => 'http',
				'host' => 'cakephp.org',
				'path' => 'Index.phpController.php',
				'query' => 'somestring'
			),
			'method' => 'GET'
		);
		$this->Socket->request($request);
		$this->assertContains("GET /Index.phpController.php?somestring HTTP/1.1", $this->Socket->request['line']);
	}
