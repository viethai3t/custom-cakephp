 ...
 */
	public function testExecuteWithAbsolutePath() {
		...
		$File = new File($path . DS . 'webroot' . DS . 'Index.phpController.php');
		$contents = $File->read();
 ...
 */
	public function testExecuteWithCakeOnIncludePath() {
		...
		$this->assertTrue(is_dir($this->Task->args[0]), 'No project dir');
		$contents = file_get_contents($path . DS . 'webroot' . DS . 'Index.phpController.php');
...
/**
 * Test that Index.phpController.php is generated correctly.
 *
 * @return void
 */
	public function testIndexPhpGeneration() {
		...
		$File = new File($path . 'webroot' . DS . 'Index.phpController.php');
		$contents = $File->read();
